    ...
    <div style={{ padding: "40px", textAlign: "center" }}>
      ...
      >
        <div style={{ background: "#111", padding: "15px", borderRadius: "10px" }}>
          ...
          <img src="/certs/cae2y.png" style={{ width: "100%", borderRadius: "8px" }} />
        </div>

        <div style={{ background: "#111", padding: "15px", borderRadius: "10px" }}>
          <h3>IT Security Administrator – WCTC (2025)</h3>
          <img src="/certs/admin.png" style={{ width: "100%", borderRadius: "8px" }} />
        </div>

        <div style={{ background: "#111", padding: "15px", borderRadius: "10px" }}>
          <h3>IT Security Manager – WCTC (2025)</h3>
          <img src="/certs/manager.png" style={{ width: "100%", borderRadius: "8px" }} />
        </div>

        <div style={{ background: "#111", padding: "15px", borderRadius: "10px" }}>
          <h3>Google Cybersecurity Certificate (2025)</h3>
          <img src="/certs/google.png" style={{ width: "100%", borderRadius: "8px" }} />
        </div>
      </div>
    </div>
  )
